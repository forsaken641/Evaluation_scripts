...
class ConfigBuilder(object):
    ...
    def basic_widget(self):
        ...
        with basic_expander:
            basic_expander.number_input("height", value=800, key="height")
            basic_expander.number_input("width", value=800, key="width")
    ...
    def physics_widget(self):
        ...
        with physics_expander:
            ...
            physics_expander.number_input("timestep", value=2, key="timestep")
